...
public class DataStepLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"V", "W", "X", "Y", "Z", "WS", "COMMENT", "LINE_COMMENT", "ABORT", "ABEND", 
			"CANCEL", "FILE", "RETURN", "NOLIST", "ARRAY", "ARRAY_NUMERIC_ELEMENTS", 
	...
	public DataStepLexer(CharStream input) {
		super(input);
